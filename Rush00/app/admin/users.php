<?php
    ...
    $sql = mysqli_query($conn, "SELECT * FROM $prefix"._."users");
    ...
    if (isset($_POST['delete'])) {
        if ($_POST['delete'] == "Delete") {
            ...
            $resLogQuery = mysqli_query($conn, "SELECT * FROM $prefix"._."users WHERE id = '$id'");

            if ($resLogQuery) {
                $query = mysqli_query($conn, "DELETE FROM $prefix"._."users WHERE id = '$id'");
                refresh();
            }
        }
    }